    ...
    <div className="font-display bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-4 antialiased text-nordic dark:text-gray-100 relative overflow-hidden w-full">
      ...
      <main className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-10">
          <Link
            href="/"
            className="inline-flex items-center justify-center w-14 h-14 bg-primary rounded-xl mb-6 shadow-soft text-white hover:opacity-90 transition-opacity"
          >
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="relative z-10">
                {loadingProvider === 'google' ? t('login.signingIn') : t('login.continueGoogle')}
              </span>
            </button>
            ...
            >
              ...
              <span className="relative z-10">
                {loadingProvider === 'github' ? t('login.signingIn') : t('login.continueGitHub')}
              </span>
            </button>
          </div>
